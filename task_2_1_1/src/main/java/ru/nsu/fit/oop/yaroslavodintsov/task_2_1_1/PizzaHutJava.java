...
public class PizzaHutJava {
    ...
    public PizzaHutJava(File employeesParameters, int storageCapacity) {
...
class PizzaHutStart extends PizzaHutJava {
    public PizzaHutStart(File employeesParameters, int warehouseCapacity) {
        super(employeesParameters, warehouseCapacity);
    }

    public static void main(String[] args) {
        new PizzaHutJava(new File("src/main/resources/Employees.json"), 10).start(10);
    }
}
