...
import ru.nsu.fit.oop.yaroslavodintsov.task_2_2_1.Direction;
import ru.nsu.fit.oop.yaroslavodintsov.task_2_2_1.Fruit;
import ru.nsu.fit.oop.yaroslavodintsov.task_2_2_1.InvalidSnakePositionException;
import ru.nsu.fit.oop.yaroslavodintsov.task_2_2_1.Position;
...
public class Snake {
    ...
    public Snake(int max) {
        ...
        int posY = posX;
        try {
            snakebody.add(new Position(posX, posY++, Direction.NORTH));
            snakebody.add(new Position(posX, posY++, Direction.NORTH));
            snakebody.add(new Position(posX, posY++, Direction.NORTH));
            snakebody.add(new Position(posX, posY, Direction.NORTH));
